...
local pref = {
    ...
    funkyArrow = true, --arrow, that point where your hp (helpful with "iconPoz" pref)
    
    hpBye = false, --when hp is full, hide health bar
    notesStart = true, --new notes appear animation
    ...
    timebarColor = 'FFFFFF', --color of timebar ('FFFFFF' - white)
