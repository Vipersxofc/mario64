...
Musicians = 'WillisaClown' --(Musician(s) Name(s))
Charters = 'MiganXD' --(Charter(s) Name(s))
...
MusicianBackgroundBarColor = 'FFFFFF'
...
--CENTER ALIGNMENT
	...
	if Alignment == 'center' then
		...
		--Art
		makeLuaText('ArtHeader', 'Artwork :', 1280, 0, -10 - BarThickness)
		addLuaText('ArtHeader')
		setTextSize('ArtHeader', HeaderSize)
