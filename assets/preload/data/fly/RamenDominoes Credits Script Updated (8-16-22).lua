...
Artists = 'ElGonzo - GlamBonnie192' --(Artist(s) Name(s))
Musicians = 'Crie7987' --(Musician(s) Name(s))
Charters = 'Crie7987' --(Charter(s) Name(s))
...
ArtistBackgroundBarColor = 'c0395f'
MusicianBackgroundBarColor = '964B00'
CharterBackgroundBarColor = '964B00'
--------------------
...
ArtistNameBorderColor = 'c0395f'
MusicianNameBorderColor = '964B00'
CharterNameBorderColor = '964B00'

TeamNamesOffset = 9 --(Postive moves UP, Negative moves DOWN)

--(Uses Hex Color Codes)
CoderHeaderColor = '4E2FC4'
ArtistHeaderColor = 'c0395f'
MusicianHeaderColor = '964B00'
CharterHeaderColor = '964B00'
--------------------
...
--CENTER ALIGNMENT
	...
	if Alignment == 'center' then
		...
		--Art
		makeLuaText('ArtHeader', 'Artist And Animator :', 1280, 0, -10 - BarThickness)
		addLuaText('ArtHeader')
		setTextSize('ArtHeader', HeaderSize)
